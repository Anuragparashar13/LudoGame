...
export default class LudoGamePage extends React.Component {
  constructor(props){
    super(props)
    this.state = {
      ...
      image1 : res.ImageAssetsGame.dice1 ,image2 : res.ImageAssetsGame.dice1,image3 : res.ImageAssetsGame.dice1,image4 : res.ImageAssetsGame.dice1
    }
  }
  moveIcon = (player,whichOne,position) => {
    console.log('==========================',player,whichOne);
    switch(player){
      case 1:
      ...
      switch(player){
        case 1 :
          ...
          if(this.state.turn1 && (this.state.isMovedBy4 || this.checkIfAnythingOpened(4))){
            ...
            switch(randomNumber){
              case 1 : 
                this.setState({image1 : res.ImageAssetsGame.dice1})
                break;
              case 2 : 
                this.setState({image1 : res.ImageAssetsGame.dice2})
                break;
              case 3 : 
                this.setState({image1 : res.ImageAssetsGame.dice3})
                break;
              case 4 : 
                this.setState({image1 : res.ImageAssetsGame.dice4})
                break;
              case 5 : 
                this.setState({image1 : res.ImageAssetsGame.dice5})
                break;
              case 6 : 
                this.setState({image1 : res.ImageAssetsGame.dice6})
                break;
            }
            if(randomNumber != 6){
        ...
        case 2  :
            ...
            if(this.state.turn2 && (this.state.isMovedBy1 || this.checkIfAnythingOpened(1))){
              ...
              switch(randomNumber){
                case 1 : 
                  this.setState({image2 : res.ImageAssetsGame.dice1})
                  break;
                case 2 : 
                  this.setState({image2 : res.ImageAssetsGame.dice2})
                  break;
                case 3 : 
                  this.setState({image2 : res.ImageAssetsGame.dice3})
                  break;
                case 4 : 
                  this.setState({image2 : res.ImageAssetsGame.dice4})
                  break;
                case 5 : 
                  this.setState({image2 : res.ImageAssetsGame.dice5})
                  break;
                case 6 : 
                  this.setState({image2 : res.ImageAssetsGame.dice6})
                  break;
              }
              if(randomNumber != 6){
        ...
        case 3:
            ...
            if(this.state.turn3 && (this.state.isMovedBy2 || this.checkIfAnythingOpened(2))){
              ...
              switch(randomNumber){
                case 1 : 
                  this.setState({image3 : res.ImageAssetsGame.dice1})
                  break;
                case 2 : 
                  this.setState({image3 : res.ImageAssetsGame.dice2})
                  break;
                case 3 : 
                  this.setState({image3 : res.ImageAssetsGame.dice3})
                  break;
                case 4 : 
                  this.setState({image3 : res.ImageAssetsGame.dice4})
                  break;
                case 5 : 
                  this.setState({image3 : res.ImageAssetsGame.dice5})
                  break;
                case 6 : 
                  this.setState({image3 : res.ImageAssetsGame.dice6})
                  break;
              }
              if(randomNumber != 6){
        ...
        case 4:
            ...
            if(this.state.turn4 && (this.state.isMovedBy3 || this.checkIfAnythingOpened(3))){
              ...
              switch(randomNumber){
                case 1 : 
                  this.setState({image4 : res.ImageAssetsGame.dice1})
                  break;
                case 2 : 
                  this.setState({image4 : res.ImageAssetsGame.dice2})
                  break;
                case 3 : 
                  this.setState({image4 : res.ImageAssetsGame.dice3})
                  break;
                case 4 : 
                  this.setState({image4 : res.ImageAssetsGame.dice4})
                  break;
                case 5 : 
                  this.setState({image4 : res.ImageAssetsGame.dice5})
                  break;
                case 6 : 
                  this.setState({image4 : res.ImageAssetsGame.dice6})
                  break;
              }
              if(randomNumber != 6){
  ...
  checkPostion = (player,whichOne,position) => {
        ...
        switch(whichOne){
          case 1 :
            if(this.state.position11 === position){
              return <Icon name="location-dot" style={styles.icons} onPress={()=>{this.moveIcon(1,1,position)}} color="red" size={20} solid />
            }
            break;
          case 2 : 
            if(this.state.position12 === position){
              return  <Icon name="location-dot" style={styles.icons} onPress={()=>{this.moveIcon(1,2,position)}} color="red" size={20} light />
            }
            break;
          case 3 : 
            if(this.state.position13 === position){
              return  <Icon name="location-pin" style={styles.icons} onPress={()=>{this.moveIcon(1,3,position)}} color="red" size={20} />
            }
            break;
          case 4 :
              if(this.state.position14 === position){
                return  <Icon name="location-pin" style={styles.icons} onPress={()=>{this.moveIcon(1,4,position)}} color="red" size={20} />
              }
              break;
          }
          break;
            ...
            switch(whichOne){
              case 1 :
                if(this.state.position21 === position){
                  return   <Icon name="rocket" style={styles.icons} onPress={()=>{this.moveIcon(2,1,position)}} color="green" size={20} />
                }
                break;
              case 2 : 
                if(this.state.position22 === position){
                  return   <Icon name="rocket" style={styles.icons} onPress={()=>{this.moveIcon(2,2,position)}} color="green" size={20} />
                }
                break;
              case 3 : 
                if(this.state.position23 === position){
                  return   <Icon name="user" style={styles.icons} onPress={()=>{this.moveIcon(2,3,position)}} color="green" size={20} />
                }
                break;
              case 4 :
                  if(this.state.position24 === position){
                    return   <Icon name="user" style={styles.icons} onPress={()=>{this.moveIcon(2,4,position)}} color="green" size={20} />
                  }
                  break;
              }
              break;
            ...
            switch(whichOne){
              case 1 :
                if(this.state.position31 === position){
                  return   <Icon name="user" style={styles.icons} onPress={()=>{this.moveIcon(3,1,position)}} color="#ed24ae" size={20} />
                }
                break;
              case 2 : 
                if(this.state.position32 === position){
                  return   <Icon name="user" style={styles.icons} onPress={()=>{this.moveIcon(3,2,position)}} color="#ed24ae" size={20} />
                }
                break;
              case 3 : 
                if(this.state.position33 === position){
                  return   <Icon name="user" style={styles.icons} onPress={()=>{this.moveIcon(3,3,position)}} color="#ed24ae" size={20} />
                }
                break;
              case 4 :
                if(this.state.position34 === position){
                  return   <Icon name="user" style={styles.icons} onPress={()=>{this.moveIcon(3,4,position)}} color="#ed24ae" size={20} />
                }
                break;
              }
              break;
          ...
          switch(whichOne){
            case 1 :
              if(this.state.position41 === position){
                return   <Icon name="user" style={styles.icons} onPress={()=>{this.moveIcon(4,1,position)}} color="blue" size={20} />
              }
              break;
            case 2 : 
              if(this.state.position42 === position){
                return   <Icon name="user" style={styles.icons} onPress={()=>{this.moveIcon(4,2,position)}} color="blue" size={20} />
              }
              break;
            case 3 : 
              if(this.state.position43 === position){
                return   <Icon name="user" style={styles.icons} onPress={()=>{this.moveIcon(4,3,position)}} color="blue" size={20} />
              }
              break;
            case 4 :
                if(this.state.position44 === position){
                  return   <Icon name="user" style={styles.icons} onPress={()=>{this.moveIcon(4,4,position)}} color="blue" size={20} />
                }
                break;
            }
          break;
    ...
    diceView(imageState){
      return(<Image style={{ width : 50,height : 50,marginLeft : 30,marginBottom : 10}} source={imageState} />)
    }
      ...
      <View style={styles.container}>
        ...
        <View style={row.Style}>
          ...
          <TouchableOpacity  onPress={()=>{this.generateRandomNumber(1)}}>
            {this.diceView(this.state.image1)}
          </TouchableOpacity>
     
          <View style={[Players.styles,{marginLeft : Dimensions.get("window").width/50,borderRightWidth : 1,marginTop : 2}]}>
          <ImageBackground source={res.ImageAssetsGame.imgHattori} style={{width: '100%', height: '100%'}}>
            <View>
              <View style={row.Style}>
          ...
          <View style={[row.Style,{ marginTop : 82,borderTopWidth : 0 }]}>
              <View style={[styles.first]}>
                  ...
                  <View style={[styles.item,{backgroundColor :res.color.ludoGreenColor}]}>
          ...
          <TouchableOpacity  onPress={()=>{ this.generateRandomNumber(2) }}>
            {this.diceView(this.state.image2)}
          </TouchableOpacity>
          <View style={[Players.styles,{borderLeftWidth : 1,marginTop : 1.7}]}>
            <ImageBackground source={res.ImageAssetsGame.imgDoremon} style={{width: '100%', height: '100%'}}>
              <View>
                  <View style={row.Style}>
                    <View style={styles.places}>
                    <TouchableOpacity>
        ...
        <View style={row.Style}>
          ...
          <View style={styles.First}>
            <View style={[row.Style,{borderLeftWidth : 2}]}>
              ...
              <View style={[styles.item,styles.red,{backgroundColor : res.color.ludoRedColor}]}>  
            ...
            <View style={[row.Style,{borderLeftWidth : 2}]}>
              ...
              <View style={styles.item}>
                ...
                <View style={[styles.item,{backgroundColor : res.color.ludoRedColor}]}>
          ...
          <View style={styles.Second}>
            <View style={[row.Style,{borderRightWidth : 2}]}>
              ...
              <View style={[styles.item,{backgroundColor : res.color.ludoYellowColor}]}>
            ...
            <View style={[row.Style,{borderRightWidth : 2}]}>
              ...
              <View style={[styles.item,styles.orange,{backgroundColor : res.color.ludoYellowColor}]}>
        ...
        <View style={row.Style}>
          ...
          <ImageBackground source={res.ImageAssetsGame.imgTomJerry} style={{width: '100%', height: '100%'}}>
            <View>
            <View style={row.Style}>
                <View style={styles.places}>
                <TouchableOpacity >
          ...
          {this.diceView(this.state.image4)}
         ...
         <View style={row.Style}>
              <View style={styles.first}>
                  ...
                  <View style={[styles.item,styles.blue,{backgroundColor : res.color.ludoBlueColor}]}>
              ...
              <View style={styles.third}>
                  ...
                  <View style={[styles.item,{backgroundColor : res.color.ludoBlueColor}]}>
          ...
          <View>
            ...
            <ImageBackground source={res.ImageAssetsGame.imgBen10} style={{width: '100%', height: '100%'}}>
              <View>
                  <View style={row.Style}>
                    <View style={styles.places}>
                    <TouchableOpacity >
          ...
          {this.diceView(this.state.image3)}
...
const styles = StyleSheet.create({
  ...
  red : {
    backgroundColor : res.color.ludoRedColor
  },  
  green : {
    backgroundColor :res.color.ludoGreenColor,
  },
  orange : {
    backgroundColor : res.color.ludoYellowColor
  },
  item : {
  ...
  blue : {
    backgroundColor : res.color.ludoBlueColor
  },
  places : {
