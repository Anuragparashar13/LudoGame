      ...
      <View>
        <ImageBackground
          ...
          <View style={{alignSelf: 'baseline', width: '100%'}}>
            <Text style={{paddingLeft: 20, paddingBottom: 10, color: '#0F4CA0', fontFamily:res.font.boldFont,fontSize:24}}>
              Select Language :
            </Text>
            <View
          ...
          style={{
            ...
            <TouchableOpacity
                ...
                <Text style={{color: res.color.liteblue,fontFamily:'Frutiger',fontSize:24}}> {res.strings.hindi} </Text>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => {
                //  changeLanguage('ar');
                ...
                style={[styles.buttonLanguag,{backgroundColor:res.color.liteblue}]}>
                <Text style={{color: res.color.blackColor,fontSize:24}}> English </Text>
              </TouchableOpacity>
        </View>
        </View>
     </ImageBackground>
